		...
		<div class="container-fluid">
			<div class="row">
              ...
              <div class="breadcrumb_content mb50">
                <h2 class="breadcrumb_title">Body Type</h2>
                <p>Ready to jump back in!</p>
                <a href="add_body_type.php" class="btn btn-primary">Add Body Type</a>
              </div>
						</div>
					</div>
                  <div class="row">
                  ...
                  <div class="row">
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        $next_page = $page_no + 1;
                        $result_count = mysqli_query(   $con,"SELECT COUNT(*) As total_records FROM `body_type`");
                        $total_records = mysqli_fetch_array($result_count);
                        $total_records = $total_records['total_records'];
                        $total_no_of_pages = ceil($total_records / $total_records_per_page);
                        $second_last = $total_no_of_pages - 1; // total pages minus 1
                            
                            $select = "select * from body_type  order by id asc LIMIT $offset, $total_records_per_page";
                            ...
                            if(mysqli_num_rows($q_run)>0){
                                ...
                                <tr>
                                  ...
                                  if($data['image_url']!=""){
                                  ?>
                                  <img width="60" src="<?php echo getServerURL(); ?>body_type_images/<?php echo $data['image_url']; ?>" />
                                  <?php } ?>
                                  </td>
                                  <td>
                                  <a href="edit_body_type.php?id=<?php echo $data['id']; ?>" class="btn  btn-primary">Edit</a>
                                    <a onclick="return confirm_delete()" href="delete.php?cmd=body_type&id=<?php echo $data['id']; ?>" class="btn  btn-danger">Delete</a>
                                  </td>
                                </tr>
                                <?php
                                }
