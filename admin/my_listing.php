		...
		<div class="container-fluid">
			<div class="row">
              ...
              <div class="breadcrumb_content mb50">
                <h2 class="breadcrumb_title">My Listings</h2>
                        ...
                        $second_last = $total_no_of_pages - 1; // total pages minus 1
                           ...
                           // $select = "select * from models order by title asc";
                            ...
                            if(mysqli_num_rows($q_run)>0){
                                ...
                                ?>
                                <tr style="<?php if($data['is_sold']==1){ echo "background-color: #DEF2D7;color: #5B7052;"; } ?>
                                    <?php if($data['is_active']==2){ echo "background-color: #ECC8C5;color: #AB3331;"; } ?>
                                ">
                              ...
                              <td>
                                  ...
                                  if($data['is_sold']==0){
                                  ?>
                                    <a onclick="return confirm_sold(<?php echo $data['id']; ?>)" href="javascript:void(0)" class="btn  btn-success">Sold</a>
                                    <form method="post" action="controlling.php" class="form_sold_<?php echo $data['id']; ?>" style="display: none;">
                                        <input type="hidden" name="cmd" value="sold_item" />
...
?>
<script>
    function confirm_sold(id){
        var conf = window.confirm("Are you sure listing is sold?");
        if(conf){
