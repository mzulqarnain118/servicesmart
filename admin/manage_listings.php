<?php
    ...
    $select= "SELECT id,listing_title,popular FROM `listings` where is_active=1";
		...
		<div class="container-fluid">
			<div class="row">
              ...
              <div class="breadcrumb_content mb50">
                <h2 class="breadcrumb_title">Manage Popular Listings</h2>
                      ...
                      <div class="shortcode_widget_form">
                        <div class="ui_kit_input mb25">
                          <form method="post" action="controlling.php" enctype="multipart/form-data">
                            <input type="hidden" name="cmd" value="manage_listings" />
...
var stateTemplate = _.template(
    '<li>' +
    	'<input name="popular_listings[]" id="<%= abbreviation %>" value="<%= id %>" type="checkbox"  <%= chek_kk %>>' +
