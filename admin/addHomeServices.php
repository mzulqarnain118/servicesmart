        ...
        <div class="col-xxl-10 offset-xxl-2 dashboard_grid_space">
              ...
              <div class="col-lg-12 mb50">
                <div class="breadcrumb_content">
                  <h2 class="breadcrumb_title">Add Home Services</h2>
...
while($row = mysqli_fetch_array($array1)){
    ...
    foreach($titles_array as $key=>$val){
        echo "<div class='col-md-3'><input type='checkbox' class='accessory-checkbox' name='home_service_type' value='$val'/> $val</div>";
    }
?>
                      </div>
                      </div>
