        ...
        <div class="col-xxl-10 offset-xxl-2 dashboard_grid_space">
              ...
              <div class="col-lg-12 mb50">
                <div class="breadcrumb_content">
                  <h2 class="breadcrumb_title">Edit Cleaning Service</h2>
            ...
            <div class="col-lg-12">
              ...
              <div class="new_property_form">
                ...
                <form class="contact_form" name="contact_form" action="controlling.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="cmd" value="createCleaningServices" />
                    <?php
...
if ($data['cleaning_service_type'] == $val) {
  echo "<input type='checkbox' class='accessory-checkbox' name='cleaning_service_type' value='$val' checked/> $val";
} else {
  echo "<input type='checkbox' class='accessory-checkbox' name='cleaning_service_type' value='$val'/> $val";
}
echo "</div>";    }
?>
                      </div>
