        ...
        <div class="col-xxl-10 offset-xxl-2 dashboard_grid_space">
              ...
              <div class="col-lg-12 mb50">
                <div class="breadcrumb_content">
                  <h2 class="breadcrumb_title">Edit</h2>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-4">
                      <div class="mb20">
                       ...
                       <div class="col-sm-6 col-md-4">
                      <div class="mb20">
                        <input name="listing_type" hidden  class="form-control form_control" value="<?php echo $data['listing_type']; ?>" type="number" placeholder="150">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="mb20">
...
if ( $type == $val) {
  echo "<input type='checkbox' class='accessory-checkbox' name='type' value='$val' checked/> $val";
} else {
  echo "<input type='checkbox' class='accessory-checkbox' name='type' value='$val'/> $val";
}
echo "</div>";    }
?>
                      </div>
