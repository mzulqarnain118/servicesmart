		...
		<div class="container-fluid">
			<div class="row">
              ...
              <div class="breadcrumb_content mb50">
                <h2 class="breadcrumb_title">City</h2>
                  ...
                  <div class="row">
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        $next_page = $page_no + 1;
                        $result_count = mysqli_query(   $con,"SELECT COUNT(*) As total_records FROM `cities`");
                        $total_records = mysqli_fetch_array($result_count);
                        $total_records = $total_records['total_records'];
                        $total_no_of_pages = ceil($total_records / $total_records_per_page);
                        $second_last = $total_no_of_pages - 1; // total pages minus 1
                            
                            $select = "select * from cities  order by id asc LIMIT $offset, $total_records_per_page";
                            ...
                            if(mysqli_num_rows($q_run)>0){
                                ...
                                <tr>
                                  ...
                                  <td><?php echo DBout($data['city_name']); ?></td>
                                  
                                  <td>
                                  <a href="edit_city.php?id=<?php echo $data['id']; ?>" class="btn  btn-primary">Edit</a>
                                    <a onclick="return confirm_delete()" href="delete.php?cmd=city&id=<?php echo $data['id']; ?>" class="btn  btn-danger">Delete</a>
                                  </td>
                                </tr>
                                <?php
                                }
