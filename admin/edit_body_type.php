<?php
    ...
    if(isset($_GET['id'])){
    $select = "select * from body_type where id='".$_GET['id']."'";
		...
		<div class="container-fluid">
			<div class="row">
              ...
              <div class="breadcrumb_content mb50">
                <h2 class="breadcrumb_title">Edit Body Type</h2>
                      ...
                      <div class="shortcode_widget_form">
                        <div class="ui_kit_input mb25">
                          ...
                          <input type="hidden" name="id" value="<?php echo $data['id'] ?>" />
                            <input type="hidden" name="cmd" value="add_body_type" />
                            <div class="form-group p-1">
                                <h5 class="short_code_title">Title</h5>
                              <input type="text" class="form-control" value="<?php echo DBout($data['title']); ?>" required="" name="title"  placeholder="Body Type Title"/>
                            </div>
