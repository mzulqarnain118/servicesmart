        ...
        <div class="col-xxl-10 offset-xxl-2 dashboard_grid_space">
              ...
              <div class="col-lg-12 mb50">
                <div class="breadcrumb_content">
                  <h2 class="breadcrumb_title">Edit Personal Care</h2>
            ...
            <div class="col-lg-12">
              ...
              <div class="new_property_form">
                ...
                <form class="contact_form" name="contact_form" action="controlling.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="cmd" value="createPersonalCare" />
                    <?php
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-4">
                      <div class="mb20">
                       ...
                       <!-- <div class="col-sm-6 col-md-4">
                      <div class="mb20">
                        <label class="form-label">Pro Verified</label>
                        <input name="pro_verified" class="form-control form_control" value="<?php echo $data['pro_verified']; ?>" type="checkbox" placeholder="150">
                      </div>
                    </div> -->
                    <div class="col-md-12">
                      <div class="mb20">
...
if ($data['personal_care_type'] == $val) {
  echo "<input type='checkbox' class='accessory-checkbox' name='personal_care_type' value='$val' checked/> $val";
} else {
  echo "<input type='checkbox' class='accessory-checkbox' name='personal_care_type' value='$val'/> $val";
}
echo "</div>";    }
?>
                      </div>
