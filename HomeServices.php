<?php 
 ...
 ?>
  ...
  <section class="inner_page_breadcrumb" style="background-image: url('images/background/HomeServices.jpg') !important; padding: 20px 0px 460px 0px;">
    <div class="container">
      <div class="row">
        <div class="col-xl-12">
          <div class="breadcrumb_content">
            ...
            <!--<ol class="breadcrumb fn-767 mt10-sm">
              ...
              <li class="breadcrumb-item active" aria-current="page"><a href="#">Home Home Services for Sale</a></li>
            </ol>-->
          </div>
        </div>
      </div>
            ...
            <div class="sidebar_widgets_wrapper">
              <div class="sidebar_advanced_search_widget">
                ...
                <ul class="sasw_list mb0">
                  ...
                  <li>
                    <h5 class="subtitle">Home Services Type</h5>
                  </li>
                  <li>
...
?>
 ...
 <div class="col-lg-7 col-xl-8">
            ...
            if (isset($_GET['page_no']) && $_GET['page_no']!="") {
                ...
                if(isset($_GET['type'])){
                    $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM `listings` where is_active=1 and listing_type=0 and home_service_type='".$_GET['type']."' $str $str_price");
                }else{
                    $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM `listings` where is_active=1 and listing_type=0  $str $str_price");
                }
          ...
          <div class="row">
              ...
              <?php
                   if(isset($_GET['type'])){
                        $select = "select * from listings where is_active=1 and listing_type=0 and  home_service_type='".$_GET['type']."'  $str $str_price order by id asc LIMIT $offset, $total_records_per_page";
                   }else{
                        $select = "select * from listings where is_active=1 and listing_type=0 $str $str_price order by id asc LIMIT $offset, $total_records_per_page";
                   }
