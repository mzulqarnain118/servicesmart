<?php 
 ...
 ?>
  ...
  <section class="inner_page_breadcrumb" style="background-image: url('images/background/PersonalCare.jpg') !important; padding: 20px 0px 460px 0px;">
    <div class="container">
      <div class="row">
        <div class="col-xl-12">
          <div class="breadcrumb_content">
            <h2 class="breadcrumb_title">Personal Care </h2>
          ...
          <div class="sidebar_widgets">
            <div class="sidebar_widgets_wrapper">
              <div class="sidebar_advanced_search_widget">
                ...
                <form method="get" action="PersonalCare.php">
                <?php
                if(isset($_GET['type'])){
                ?>
                ...
                <ul class="sasw_list mb0">
                  ...
                  <li>
                    <h5 class="subtitle">Personal Care Type</h5>
                  </li>
                  <li>
                  
                <div class="checkbox-group">
  <?php
$array1 = mysqli_query($con,"select title from categories where cat_type='Personal Care' order by title asc");
...
?>
         ...
         <div class="col-lg-7 col-xl-8">
            ...
            if (isset($_GET['page_no']) && $_GET['page_no']!="") {
                ...
                if(isset($_GET['type'])){
                    $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM `listings` where is_active=1 and listing_type=2 and personal_care_type='".$_GET['type']."' $str $str_price");
                }else{
                    $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM `listings` where is_active=1 and listing_type=2  $str $str_price");
                }
            ...
            <div class="listing_filter_row db-lg">
              <div class="col-xl-5">
                <div class="page_control_shorting left_area tac-lg mb30-767 mt15">
                  <p>We found <span class="heading-color fw600"><?php echo $total_records; ?></span> Personal Care available for you</p>
                </div>
              </div>
              <div class="col-xl-7">
          ...
          <div class="row">
              ...
              <?php
                   if(isset($_GET['type'])){
                        $select = "select * from listings where is_active=1 and listing_type=2 and  personal_care_type='".$_GET['type']."'  $str $str_price order by id asc LIMIT $offset, $total_records_per_page";
                   }else{
                        $select = "select * from listings where is_active=1 and listing_type=2 $str $str_price order by id asc LIMIT $offset, $total_records_per_page";
                   }
